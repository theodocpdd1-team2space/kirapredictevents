...
<div class="space-y-6 max-w-5xl">
  <div>
    <h1 class="text-4xl font-semibold tracking-tight text-slate-900 dark:text-white transition-colors">Add Equipment</h1>
    <p class="text-slate-500 dark:text-slate-400 mt-2 transition-colors">Add new equipment to inventory</p>
  </div>
  ...
  <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden transition-colors duration-300">
    ...
    <form method="POST" action="{{ route('inventories.store') }}" enctype="multipart/form-data" class="p-8">
      @csrf
